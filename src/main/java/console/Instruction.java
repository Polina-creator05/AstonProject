...
public class Instruction {
    private final static String messageClass = "Введите цифру от 1 до 3 в соответствии с типом данных, " +
            "подлежащих сортировке согласно таблице";

    private final static String messageFill = "Введите цифру от 1 до 3 в соответствии с желаемым вариантом " +
            "заполнения массива данных согласно таблице";

    private final static String messageSort = "Введите цифру от 1 до 2 в соответствии с желаемым типом " +
            "сортировки согласно таблице";

    private final static String messageLenght = "Введите количество объектов, подлежащих обработке, " +
            "используя только арабские цифры. Количество объектов должно быть не менее 2-х";

    private final static String messageContinue = "Желаете завершить программу? " +
            "Введите цифры от 1 до 2 согласно таблице";

    private final static String messageReadFromFile = "Укажите путь к файлу, из которого необходимо " +
            "считать данные для заполнения массива";
    ...
    private  final static String messageReadFromConsole = "Укажите данные для заполнения массива, " +
            ...
            "начиная каждый объект с новой строки." +
